...
class Currency_report extends StatefulWidget {

  @override
  State<Currency_report> createState() => _Currency_reportState();
}

class _Currency_reportState extends State<Currency_report> {
  ...
  Future<List<Map<String, dynamic>>> fetchCourseData() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('${MyConstants.baseUrl}/course_api/view_analysis_data'),
        headers: {
