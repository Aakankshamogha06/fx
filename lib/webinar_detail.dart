...
class Webinar_detail extends StatefulWidget {

  final int id;
  Webinar_detail({required this.id});

  @override
  State<Webinar_detail> createState() => _Webinar_detailState();
}

class _Webinar_detailState extends State<Webinar_detail> {
  ...
  Future<List<Map<String, dynamic>>> fetchCourseData() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('${MyConstants.baseUrl}/course_api/webinar_data/${widget.id}'),
        headers: {
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: FittedBox(
                      fit: BoxFit.contain,
                      child: course.containsKey('image')
                          ? Image(
                  ...
                  Container(
                    child:          Html(
                      data: (courseData[0]['long_desc']) ?? 'N/A',
